...
ClfHeader = "retrain_SVC_seq_rbf_1_0.01_bal_"
...
ClfHeader = "retrain_MLP_seq_lbfgs_1.0_300.150.100_none_"
...
ClfHeader = "retrain_MLP_seq_lbfgs_1.0_250.150.100_SMOTETomek_"
...
ClfHeader = "retrain_ada_seq_50_1_SAMME.R_none_"
...
ClfHeader = "retrain_SVC_str_rbf_1_0.001_bal_"
...
ClfHeader = "retrain_MLP_str_adam.es20_0.1_250.125.100_none_"
...
ClfHeader = "retrain_MLP_str_lbfgs_1.0_125.100.10_SMOTETomek_"
...
ClfHeader = "retrain_ada_str_50_1_SAMME.R_none_"
clf = CalibratedClassifierCV( AdaBoostClassifier(base_estimator=DecisionTreeClassifier(max_depth=1), n_estimators=50, learning_rate=1.0, algorithm='SAMME.R', random_state=11), cv=5)
clf.fit(learnset_features_str, learnset_obs)
pkl_name = ClfHeader + learnheader + ".pkl"
joblib.dump( clf, pkl_name )
